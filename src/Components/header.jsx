        ...
        <div className='md:m-auto flex flex-col flex-wrap text-wrap w-auto h-auto' style={{maxWidth:"1450px"}} >
            <div className="flex justify-around items-center pt-4 pb-4 font-mono flex-wrap text-white">
                <div className='flex md:flex-row flex-col md:gap-12 gap-2 lg:p-0 md:text-lg text-sm'>
                    <div className='hover:border-b-4 border-yellow-300 hover:cursor-pointer' onClick={()=> navigate("/")}>HOME</div>
                    <div className='hover:border-b-4 border-yellow-300 hover:cursor-pointer'>PRODUCT</div>
                    <div className='hover:border-b-4 border-yellow-300 hover:cursor-pointer' onClick={()=> navigate("/solution")}>SOLUTION</div>
                    <div className='hover:border-b-4 border-yellow-300 hover:cursor-pointer' onClick={() => navigate("/integration")}>INTERGRATION</div>
                    <div className='hover:border-b-4 border-yellow-300 hover:cursor-pointer'>CONTACT</div>
                </div>
