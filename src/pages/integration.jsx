    ...
    return(
        <>
            <div className="font-mono">
                <div className='md:m-auto flex flex-col flex-wrap text-wrap pb-16' style={{maxWidth:"1450px"}} >
                    <div className="flex justify-center flex-wrap w-auto h-auto">
                        <div className="flex flex-col items-center mt-9">
                            ...
                            <h1 className="break-words text-center mt-2 md:text-3xl text-lg font-bold" style={{maxWidth : "52rem"}}>Currently we provide standardized solutions for the following document types.</h1>
                        </div>
                    </div>
                    <div className="mt-14 flex justify-end">
                        <div>
                            <button className=" text-white w-fit md:pl-7 md:p-1 md:pr-7 md:text-3xl p-1 pl-5 pr-5 text-xl rounded-lg hover:bg-yellow-400 bg-gray-700 flex flex-col items-center mr-9" onClick={() => navigate("/process")}>
                                NEXT
