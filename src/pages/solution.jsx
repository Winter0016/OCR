                ...
                <div className='md:m-auto flex flex-col flex-wrap text-wrap pb-16' style={{maxWidth:"1450px"}} >
                    <div className="flex justify-center flex-wrap w-auto h-auto">
                        <div className="flex flex-col items-center mt-9">
                            ...
                            <h1 className="break-words text-center mt-2 md:text-3xl text-lg font-bold" style={{maxWidth : "52rem"}}>We offers individual solutions for the most diverse requirements, applications and target groups</h1>
                        </div>
                    </div>
